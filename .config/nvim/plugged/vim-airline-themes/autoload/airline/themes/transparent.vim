...
let s:golden   = [143, '#a9b665']
let s:pink     = [175, '#d3869b']
let s:red      = [167, '#ea6962']
let s:blue     = [109, '#7daea3']
let s:orange   = [166, '#e78a4e']
...
" Error
let s:E3 = [s:darkgray[1]  , s:red[1], s:darkgray[0], s:red[0]]
...
" Errorsi
let g:airline#themes#transparent#palette.normal.airline_error = s:E3
