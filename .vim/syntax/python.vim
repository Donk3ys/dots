...
if s:Enabled('g:python_highlight_class_vars')
    syn keyword pythonSelfKeyword    self cls
endif
...
if s:Enabled('g:python_highlight_builtin_objs')
    ...
    syn keyword pythonBuiltinObj  __debug__ __doc__ __file__ __name__ __package__ __init__ __import__
    syn keyword pythonBuiltinObj  __loader__ __spec__ __path__ __cached__ __repr__
endif
...
if v:version >= 508 || !exists('did_python_syn_inits')
    ...
    "HiLink pythonSelfKeyword       pythonSelfKeyword
